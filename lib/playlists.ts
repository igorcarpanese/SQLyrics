...
export const PLAYLISTS: Playlist[] = [
  ...
  },
  {
    ...
    artists: [
      "Roberto Carlos", "Zezé Di Camargo e Luciano", "Bruno e Marrone", "Wesley Safadão", "Gusttavo Lima",
      "Luan Santana", "Ivete Sangalo", "Aviões do Forró", "Jorge e Mateus", "Roupa Nova",
      "Marília Mendonça", "Amado Batista", "Leonardo", "Henrique e Juliano", "Chitãozinho e Xororó",
      "Banda Calypso", "Raça Negra", "Michel Teló", "Rionegro e Solimões", "Sandy e Júnior",
      "Eduardo Costa", "Jota Quest", "Víctor e Léo", "Paula Fernandes", "Maiara e Maraísa",
      "Daniel", "Ana Carolina", "Calcinha Preta", "Zé Neto e Cristiano", "Sorriso Maroto",
      "Fagner", "Anitta", "Fábio Jr.", "Leandro e Leonardo", "Marisa Monte",
      "Matheus e Kauan", "Fernando e Sorocaba", "Babado Novo", "Os Barões da Pisadinha", "Rick e Renner",
      "Capital Inicial", "Guilherme e Santiago", "João Bosco e Vinícius", "Legião Urbana", "Lucas Lucco",
      "Lulu Santos", "Charlie Brown Jr.", "Zeca Pagodinho", "Caetano Veloso", "Skank",
      "Naiara Azevedo", "Simone e Simaria", "Gian e Giovani", "Marcos e Belutti", "Alexandre Pires",
      "Exaltasamba", "Raul Seixas", "Ferrugem", "Titãs", "CPM 22", "O Rappa", "Paralamas do Sucesso",
      "Engenheiros do Hawaii", "Biquini Cavadão", "Pitty", "Rita Lee", "Cazuza", "Barão Vermelho",
      "Chico Buarque", "Gilberto Gil", "Tim Maia", "Seu Jorge", "Djavan", "Milton Nascimento",
      "Ney Matogrosso", "Alceu Valença", "Zé Ramalho", "Jorge Ben Jor", "Elis Regina", "Maria Bethânia",
      "Gal Costa", "Cassia Eller", "Sidney Magal", "Mamonas Assassinas", "Mc Kevinho", "Mc Bin Laden",
      "Mc Kekel", "Mc Loma", "Mc Don Juan", "Mc Bruninho", "Mc Davi", "Mc G15", "Mc Gui",
      "Mc Koringa", "Mc Livinho", "Mc Kevin o Chris", "Mc Sapão", "Mc Wm", "Ludmilla", "Pabllo Vittar",
      "Gloria Groove", "Lexa", "Luísa Sonza", "IZA", "Leo Santana", "Banda Eva", "Chiclete com Banana",
      "Asa de Águia", "É o Tchan", "Claudia Leitte", "Daniela Mercury", "Thiaguinho", "Dilsinho",
      "Mumuzinho", "Fundo de Quintal", "Alcione", "Beth Carvalho", "Diogo Nogueira", "Martinho da Vila"
    ],
  },
  {
    id: "k-pop",
