...
export const PLAYLISTS: Playlist[] = [
  ...
  },
  {
    ...
    artists: [
      // Top Sertanejo / Arrocha / Modão
      "Zezé Di Camargo e Luciano", "Bruno e Marrone", "Wesley Safadão", "Gusttavo Lima",
      "Luan Santana", "Jorge e Mateus", "Marília Mendonça", "Amado Batista", "Leonardo",
      "Henrique e Juliano", "Chitãozinho e Xororó", "Michel Teló", "Rionegro e Solimões",
      "Eduardo Costa", "Víctor e Léo", "Paula Fernandes", "Maiara e Maraísa", "Daniel",
      "Zé Neto e Cristiano", "Fagner", "Leandro e Leonardo", "Matheus e Kauan",
      "Fernando e Sorocaba", "Os Barões da Pisadinha", "Rick e Renner", "Guilherme e Santiago",
      "João Bosco e Vinícius", "Lucas Lucco", "Naiara Azevedo", "Simone e Simaria", "Gian e Giovani",
      "Marcos e Belutti", "Milionário e José Rico", "Thaeme e Thiago", "João Neto e Frederico",
      "Matogrosso e Mathias", "Teodoro e Sampaio", "Edson e Hudson", "César Menotti e Fabiano",
      "Jonas Esticado", "Cristiano Araújo", "Felipe Araújo", "Sérgio Reis", "Léo Magalhães",
      "Zé Felipe", "Maria Cecília e Rodolfo", "Israel e Rodolffo", "José Augusto", "João Gomes",
      "Trio Parada Dura", "Mano Walter", "Bonde do Forró", "Cezar e Paulinho", "Rio Negro e Solimões",
      "Gino e Geno", "Zé Vaqueiro", "Mato Grosso e Mathias", "Almir Sater", "As Galvão", "Christian e Ralf",
      "Daniela", "Lauana Prado", "Yasmin Santos", "Roberta Miranda", "Renato Teixeira", "Gaby Amarantos",
      
      // Top Pop / Axé / Funk / Forró
      "Roberto Carlos", "Ivete Sangalo", "Aviões do Forró", "Roupa Nova", "Banda Calypso",
      "Sandy e Júnior", "Ana Carolina", "Calcinha Preta", "Anitta", "Fábio Jr.", "Babado Novo",
      "Lulu Santos", "Alexandre Pires", "Kelly Key", "Fábio Jr", "Ludmilla", "Pabllo Vittar",
      "Gloria Groove", "Lexa", "Luísa Sonza", "IZA", "Leo Santana", "Banda Eva", "Chiclete com Banana",
      "Asa de Águia", "É o Tchan", "Claudia Leitte", "Daniela Mercury", "Cavaleiros do Forró",
      "Xand Avião", "Companhia do Calypso", "Mastruz Com Leite", "Banda Cheiro de Amor", "KLB",
      "Latino", "Banda Magníficos", "RBD (Rebelde)", "Gatinha Manhosa", "Jammil e Uma Noites",
      "Margareth Menezes", "Léo Santana", "Banda Beijo", "Timbalada", "Netinho", "Harmonia do Samba",
      "Cheiro de Amor", "Banda Mel", "Olodum", "Ara Ketu", "Tchakabum", "Saulo Fernandes", "Emanuelle Araújo",
      "Sandy", "Junior Lima", "Wanessa Camargo", "Rouge", "Br'oz", "Tihuana", "D'Black", "Perlla",
      "Mc Kevinho", "Mc Bin Laden", "Mc Livinho", "Mc Loma", "Mc Gui", "Mc Don Juan", "Mc Kekel",
      "Mc Bruninho", "Mc Davi", "Mc G15", "Mc Koringa", "Mc Kevin o Chris", "Mc Sapão", "Mc Wm",
      "MC Kevin", "Mc Lan", "Mc Leozinho", "Nego do Borel", "Bonde do Tigrão", "MC Marcinho",
      "Claudinho e Buchecha", "Buchecha", "MC Guimê", "Tati Quebra Barraco", "Valesca Popozuda",

      // Top MPB / Samba / Pagode / Bossa Nova / Classics
      "Raça Negra", "Sorriso Maroto", "Marisa Monte", "Zeca Pagodinho", "Caetano Veloso",
      "Exaltasamba", "Ferrugem", "Chico Buarque", "Gilberto Gil", "Tim Maia", "Seu Jorge",
      "Djavan", "Milton Nascimento", "Ney Matogrosso", "Alceu Valença", "Zé Ramalho",
      "Jorge Ben Jor", "Elis Regina", "Maria Bethânia", "Gal Costa", "Cassia Eller", "Sidney Magal",
      "Thiaguinho", "Dilsinho", "Mumuzinho", "Fundo de Quintal", "Alcione", "Beth Carvalho",
      "Diogo Nogueira", "Martinho da Vila", "Só Pra Contrariar", "Jorge Vercillo", "Grupo Revelação",
      "Nelson Gonçalves", "Guilherme Arantes", "Reginaldo Rossi", "Armandinho", "Belo",
      "João Nogueira", "Arlindo Cruz", "Zeca Baleiro", "Lenine", "Zélia Duncan", "Cássia Eller",
      "Tribalistas", "Toquinho", "Vinicius de Moraes", "Tom Jobim", "João Gilberto", "Nara Leão",
      "Cartola", "Pixinguinha", "Luiz Gonzaga", "Dominguinhos", "Elba Ramalho", "Geraldo Azevedo",
      "Fagner", "Belchior", "Milton Nascimento", "Lô Borges", "Beto Guedes", "Flávio Venturini",
      "14 Bis", "Sá, Rodrix e Guarabyra", "Clube da Esquina", "Ivan Lins", "Gonzaguinha", "Moraes Moreira",
      "Pepeu Gomes", "Baby do Brasil", "Novos Baianos", "Secos & Molhados", "João Bosco", "Aldir Blanc",
      "Edu Lobo", "Beto Jamaica", "Compadre Washington", "Wando", "Fábio Stella", "Gilliard",
      "Moacyr Franco", "Agnaldo Rayol", "Agnaldo Timóteo", "Nelson Ned", "Waldick Soriano", "Evaldo Braga",
      "Odair José", "Peninha", "Byafra", "Rosana", "Joanna", "Elymar Santos", "Jorge Aragão",
      "Almir Guineto", "Leci Brandão", "Jovelina Pérola Negra", "Dona Ivone Lara", "Clara Nunes",
      "Clementina de Jesus", "Marlene", "Emilinha Borba", "Dalva de Oliveira", "Elza Soares",
      "Os Trapalhões", "Trem da Alegria", "Balão Mágico", "Xuxa", "Angélica", "Mara Maravilha",

      // Top Rock Nacional / Reggae / Alternative
      "Jota Quest", "Titãs", "CPM 22", "O Rappa", "Paralamas do Sucesso", "Engenheiros do Hawaii",
      "Biquini Cavadão", "Pitty", "Rita Lee", "Cazuza", "Barão Vermelho", "Mamonas Assassinas",
      "Capital Inicial", "Legião Urbana", "Charlie Brown Jr.", "Skank", "Kid Abelha", "Cidade Negra",
      "Natiruts", "Maneva", "Planta e Raiz", "Maskavo", "Chimarruts", "O Surto", "Los Hermanos",
      "Detonautas", "NX Zero", "Fresno", "Strike", "Hevo84", "Gloria", "Cine", "Restart",
      "Os Mutantes", "Camisa de Vênus", "Ira!", "RPM", "Nenhum de Nós", "Roupa Nova",
      "Herva Doce", "Rádio Táxi", "Blitz", "Lobão", "Ultraje a Rigor", "Plebe Rude", "Inocentes",
      "Ratos de Porão", "Raul Seixas", "Marcelo D2", "Planet Hemp", "Gabriel O Pensador", "Racionais MCs",
      "Projeta", "Emicida", "Criolo", "Rael", "Black Alien", "ConeCrewDiretoria", "Pollo", "Projota",
      "Rashid", "Rincon Sapiência", "Baco Exu do Blues", "Djonga", "Matuê", "Filipe Ret", "L7NNON",
      "Xamã", "Orochi", "MC Cabelinho", "BIN", "Borges", "Chefin", "Teto", "WIU", "Kawe", "KayBlack"
    ],
  },
  {
    id: "k-pop",
